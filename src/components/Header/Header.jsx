    ...
    <NavbarContainer>
      <NavbarContent>
        ...
        <RightSection>
          {isEmailVerified && user && (
            <SearchContainer>
              {/* Reemplazamos el componente de búsqueda interno por nuestro componente Search */}
              <Search />
            </SearchContainer>
          )}
          ...
          {user ? (
            <>
              {isEmailVerified && (
                <UserSection className="user-dropdown-container">
                  <UserAvatar onClick={() => setUserDropdownOpen(!isUserDropdownOpen)}>
                    {user.photoURL ? (
        ...
        {isMenuOpen && (
          ...
          >
            {isEmailVerified && user && (
              <>
                <MobileSearchSection>
                  {/* Reemplazamos el formulario de búsqueda por nuestro componente Search */}
                  <Search />
                </MobileSearchSection>
                <MobileDivider />
