...
const Header = () => {
  ...
  // Función para alternar entre "Ingresar" y "Registrarme"
  ...
  return (
    <Nav>
      ...
      <LeftMenu>
        ...
        {/* Mostrar "Películas" y "Series" solo si el usuario está autenticado y verificado */}
              ...
              <>
                ...
                {isMenuOpen && (
                  <DropdownMenu>
                    ...
                    <li>Series</li>
                    <Separator />
                    <DropdownEmail>{truncateEmail(user.email)}</DropdownEmail>
                    <Separator />
                    <LogoutButton onClick={handleLogOut}>Cerrar sesión</LogoutButton>
                  </DropdownMenu>
                )}
