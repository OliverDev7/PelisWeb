...
const VideoPlayer = () => {
  ...
  // Nuevo estado para mini-reproductor
  ...
  useEffect(() => {
    const handleFullscreenChange = () => {
      ...
      if (!document.fullscreenElement && !isExiting.current && !isMiniPlayer) {
        handleExit()
      }
    }
  ...
  }, [isPlaying, isFullscreen, isMuted, isMiniPlayer])
  ...
  // Función para alternar el modo mini-reproductor
  ...
  return (
    ...
    >
          ...
          >
            ...
            <TopControls>
              ...
              <TopRightControls>
                ...
                <ControlButton onClick={toggleMiniPlayer}>
                  {isMiniPlayer ? (
      ...
      {/* Barra de control para mini-reproductor */}
      {isMiniPlayer && (
        <MiniPlayerControls>
          <MiniPlayerTitle>{movie.title || "Video"}</MiniPlayerTitle>
          <MiniPlayerButtons>
            <MiniPlayerButton onClick={togglePlay}>
              {isPlaying ? (
            ...
            <MiniPlayerButton onClick={toggleFullscreen}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22Z"
                  stroke="currentColor"
            ...
            <MiniPlayerButton onClick={handleExit}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
...
const PlayerContainer = styled.div`
  position: fixed;
  top: ${(props) => (props.$isMiniPlayer ? "auto" : "0")};
  bottom: ${(props) => (props.$isMiniPlayer ? "20px" : "0")};
  left: ${(props) => (props.$isMiniPlayer ? "auto" : "0")};
  right: ${(props) => (props.$isMiniPlayer ? "20px" : "0")};
  width: ${(props) => (props.$isMiniPlayer ? "320px" : "100%")};
  height: ${(props) => (props.$isMiniPlayer ? "180px" : "100%")};
  ...
  overflow: hidden;
  border-radius: ${(props) => (props.$isMiniPlayer ? "12px" : "0")};
  box-shadow: ${(props) => (props.$isMiniPlayer ? "0 4px 20px rgba(0, 0, 0, 0.5)" : "none")};
  transition: all 0.3s ease;
  
  @media (max-width: 768px) {
    width: ${(props) => (props.$isMiniPlayer ? "240px" : "100%")};
    height: ${(props) => (props.$isMiniPlayer ? "135px" : "100%")};
    bottom: ${(props) => (props.$isMiniPlayer ? "10px" : "0")};
    right: ${(props) => (props.$isMiniPlayer ? "10px" : "0")};
  }
  
  @media (max-width: 480px) {
    width: ${(props) => (props.$isMiniPlayer ? "180px" : "100%")};
    height: ${(props) => (props.$isMiniPlayer ? "101px" : "100%")};
  }
`
...
const ControlsOverlay = styled.div`
  ...
  z-index: 5;
  padding: ${(props) => (props.$isMiniPlayer ? "10px" : "20px")};
...
// Nuevos estilos para mini-reproductor
...
const MiniPlayerTitle = styled.div`
  color: white;
  font-size: 14px;
  font-weight: 500;
  white-space: nowrap;
...
const MiniPlayerButtons = styled.div`
  display: flex;
  gap: 8px;
`

const MiniPlayerButton = styled.button`
